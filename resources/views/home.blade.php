...
<body>
        ...
        <div class="col-12">
          <nav class="main-nav">
            ...
            <a href="index.html" class="logo">
              <h4>KHALIS <img src="{{ asset('assets/img/logo.png')}}" alt="" ></h4>
            </a>
            <!-- ***** Logo End ***** -->
            <!-- ***** Menu Start ***** -->
            <ul class="nav">
          ...
          <div class="row">
            <div class="col-lg-6 align-self-center">
              <div class="left-content header-text wow fadeInLeft" data-wow-duration="1s" data-wow-delay="1s">
                <div class="row">
                  ...
                  <div class="col-lg-12">
                    <h2>Periklanan, Suku Cadang, Percetakan & Komputer</h2>
                  </div>
                  <div class="col-lg-12">
            ...
            <div class="col-lg-6">
              <div class="right-image wow fadeInRight" data-wow-duration="1s" data-wow-delay="0.5s">
                <img src="{{ asset('assets/img/banner-right-image.png') }}" alt="">
              </div>
            </div>
          </div>
        </div>
      ...
      <div class="row">
        ...
        <div class="col-lg-6 align-self-center wow fadeInRight" data-wow-duration="1s" data-wow-delay="0.5s">
          <div class="section-heading">
            <h6>Tentang Kami</h6>
            <h2>Perusahaan <em>yang</em> agency &amp; consult your website <span>with us</span></h2>
          </div>
          <div class="row">
            <div class="col-lg-4 col-sm-4">
      ...
      <div class="row">
        <div class="col-lg-6 offset-lg-3">
          <div class="section-heading wow bounceIn" data-wow-duration="1s" data-wow-delay="0.2s">
            <h6>Jasa Kami</h6>
            <h2>Apa Yang Kami <span>Sediakan</span> Kepada <em>Klien Kami</em></h2>
          </div>
        </div>
      </div>
    </div>
        ...
        <div class="row">
          ...
          <div class="col-lg-8">
            <div class="right-content">
              <h4>Periklanan</h4>
              <p>Kami menyediakan layanan periklanan yang efektif untuk meningkatkan visibilitas bisnis Anda.</p>
            </div>
          </div>
        </div>
      </div>
    ...
    <div class="col-lg-4">
      <div class="service-item wow bounceInUp" data-wow-duration="1s" data-wow-delay="0.4s">
        <div class="row">
          ...
          <div class="col-lg-8">
            <div class="right-content">
              <h4>Industri Kantor</h4>
              <p>Kami menyediakan solusi lengkap untuk kebutuhan industri kantor Anda.</p>
            </div>
          </div>
        </div>
      </div>
      ...
      <div class="service-item wow bounceInUp" data-wow-duration="1s" data-wow-delay="0.5s">
        <div class="row">
          ...
          <div class="col-lg-8">
            <div class="right-content">
              <h4>Suku Cadang</h4>
              <p>Kami menyediakan suku cadang berkualitas untuk berbagai keperluan.</p>
            </div>
          </div>
        </div>
      </div>
        ...
        <div class="row">
          ...
          <div class="col-lg-8">
            <div class="right-content">
              ...
              <p>Kami menawarkan layanan percetakan dan penerbitan dengan kualitas terbaik.</p>
            </div>
          </div>
        </div>
      </div>
      ...
      <div class="service-item wow bounceInUp" data-wow-duration="1s" data-wow-delay="0.7s">
        <div class="row">
          ...
          <div class="col-lg-8">
            <div class="right-content">
              <h4>Elektronik</h4>
              <p>Kami menyediakan berbagai perangkat elektronik berkualitas tinggi.</p>
            </div>
          </div>
        </div>
      </div>
      ...
      <div class="service-item wow bounceInUp" data-wow-duration="1s" data-wow-delay="0.8s">
        <div class="row">
          ...
          <div class="col-lg-8">
            <div class="right-content">
              <h4>Komputer</h4>
              <p>Kami menyediakan berbagai produk komputer dan perlengkapannya.</p>
            </div>
          </div>
        </div>
      </div>
  ...
  <footer>
    <div class="container">
      <div class="row">
        <div class="col-lg-12">
          <p>Copyright © 2024 PT. Khalis Briliant, Ltd. All Rights Reserved.
        </div>
      </div>
    </div>
  </footer>
